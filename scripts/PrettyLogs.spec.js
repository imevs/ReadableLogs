    ...
    describe("PrettyLogs", () => {
        describe("parseMessage", () => {
            ...
            it("should parse JSON object", () => {
                assert.deepEqual(index_1.parseMessage({ "a": 1 }), [
                    { path: "", text: "{", type: "" },
            ...
            it("should parse JSON object with changed attr", () => {
                ...
                assert.deepEqual(index_1.parseMessage({ "a": 1 }, { showDifferences: true }, prevObject), [
                    { path: "", text: "{", type: "" },
                    { path: "/a", text: '"a"', type: "key" },
                    { path: "/a", text: ":", type: "" },
            ...
            it("should parse JSON object with added items in array", () => {
                const prevObject = { a: [] };
                const result = index_1.parseMessage({ a: [{ b: 1 }, { b: 2 }] }, { showDifferences: true }, prevObject);
            ...
            it("should parse JSON object with changed sub object", () => {
                ...
                assert.deepEqual(index_1.parseMessage({ "a": { c: 2 } }, { showDifferences: true }, prevObject), [
                    { path: "", text: "{", type: "" },
                    { path: "/a", text: '"a"', type: "key" },
                    { path: "/a", text: ":{", type: "" },
            ...
            it("should highlight correctly keys in not changed object", () => {
                ...
                assert.deepEqual(index_1.parseMessage({ e: "2", a: { c: { d: 1 } } }, { showDifferences: true }, prevObject), [
                    { path: "", text: "{", type: "" },
            ...
            it("should correctly highlight changes in modified object", () => {
                ...
                assert.deepEqual(index_1.parseMessage({ a: 1, c: { e: 1 } }, { showDifferences: true }, prevObject), [
                    { text: "{", type: "", path: "" },
                    { text: '"a"', type: "key", path: "/a" },
                    { text: ":", type: "", path: "/a" },
            ...
            it("should correctly highlight multiple changes", () => {
                ...
                assert.deepEqual(index_1.parseMessage(current, { showDifferences: true }, prevObject), [
                    { text: "{", type: "", path: "" },
            ...
            it("should search for removed parts in simple object", () => {
                ...
                const result = index_1.parseMessage(current, { showDifferences: true }, prevObject);
                assert.deepEqual(result, [
                    { text: "{", type: "", path: "" },
                    { text: '"a"', type: "key", path: "/a" },
                    { text: ":4}", type: "", path: "/a" },
        ...
        describe("highlightErrorsInJson", () => {
            it("should add comments in multiline JSON", () => {
                const result = index_1.highlightErrorsInJson({ a: { b: { c: 2, d: 3 } } }, [
