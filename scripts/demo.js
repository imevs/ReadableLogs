define(["require", "exports", "./index", "./testData", "./formattingUtils"], function (require, exports, index_1, testData_1, formattingUtils_1) {
    ...
    function executeFormatter(data) {
        ...
        const result = index_1.parseMessage(data.current, { showDifferences: true, formatMultiline: false }, data.prevObject);
        console.info(...formattingUtils_1.formatForLoggingInBrowser("Formatted message: ", result));
        console.log(result);
        const result2 = index_1.parseMessage(data.current, { showDifferences: false, formatMultiline: true }, data.prevObject);
        ...
        document.querySelector("#demo_input_prevMessage").innerHTML =
            formattingUtils_1.formatMultiLineTextAsHTML(JSON.stringify((_a = data.prevObject) !== null && _a !== void 0 ? _a : {}, null, "  "));
    }
